# slightly edited from https://github.com/funkelab/funlib.learn.torch/blob/master/funlib/learn/torch/models/unet.py
...
class UNet(torch.nn.Module):
    ...
    def __init__(
        ...
        The U-Net expects 3D tensors shaped like::
            ...
            ``(batch=1, channels, depth, height, width)``.

        This U-Net performs only "valid" convolutions, i.e., sizes of the
        feature maps decrease after each convolution. # removed 4D conv 
